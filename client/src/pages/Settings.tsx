...
export default function Settings() {
  ...
  const appVersion = '1.0.32'; // Will be auto-updated by build process
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="text-gray-600 dark:text-gray-400">
              {Array.isArray(userClasses) ? userClasses.length : 0} / {isPremium ? '∞' : FREE_TIER_LIMITS.classes}
            </span>
          </div>
          <div className="flex items-center justify-between">
            <span className="text-gray-700 dark:text-gray-300">Notes Limit</span>
            <span className="text-gray-600 dark:text-gray-400">
              {Array.isArray(userNotes) ? userNotes.length : 0} / {isPremium ? '∞' : FREE_TIER_LIMITS.notes}
            </span>
          </div>
          {!isPremium && (
            <>
